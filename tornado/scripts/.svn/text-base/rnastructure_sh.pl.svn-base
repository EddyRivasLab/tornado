...
if (@ARGV) {
        print "usage:  rnastructure_sh.pl [options] \n\n";
        print "options:\n";
	print "-v        :  be verbose\n";
	exit;
}
...
my $dir_full     = "$tornado_full/notebook/milestone8/RNAstructure";
...
my $rnastructure_script = "$scripts/run-maxexpect.pl";
...
sub create_parent_readme_file {
    ...
    print FILE "\n";
     ...
     #mea gamma=1
     for (my $v = 0; $v < $NV; $v ++) { 
	$shfile = "$shscripts/$version[$v]/m8_fold_mea_gamma1_$version[$v].sh";
	print FILE "sh $shfile\n";
    }
    print FILE "\n";
     ...
     #mea_auc
    for (my $v = 0; $v < $NV; $v ++) { 
	$shfile = "$shscripts/$version[$v]/m8_fold_mea_auc_$version[$v].sh";
	print FILE "sh $shfile\n";
    }
    print FILE "\n";
    ...
    #cyk Rfam3D
    for (my $v = 0; $v < $NV; $v ++) { 
	$shfile = "$shscripts/$version[$v]/m8_fold_ Rfam3D_cyk_$version[$v].sh";
	print FILE "sh $shfile\n";
    }
    print FILE "\n";
     ...
     #mea gamma=1 Rfam3D
     for (my $v = 0; $v < $NV; $v ++) { 
	$shfile = "$shscripts/$version[$v]/m8_fold_Rfam3D_mea_gamma1_$version[$v].sh";
	print FILE "sh $shfile\n";
    }
    print FILE "\n";
     ...
     #mea_auc Rfam3D
    for (my $v = 0; $v < $NV; $v ++) { 
	$shfile = "$shscripts/$version[$v]/m8_fold_Rfam3D_mea_auc_$version[$v].sh";
	print FILE "sh $shfile\n";
    }
    print FILE "\n";
    ...
    #cyk boostrap
    for (my $v = 0; $v < $NV; $v ++) { 
	$shfile = "$shscripts/$version[$v]/m8_fold_boostrap_cyk_$version[$v].sh";
	print FILE "sh $shfile\n";
    }
    print FILE "\n";

     #mea gamma=1 boostrap
     for (my $v = 0; $v < $NV; $v ++) { 
	$shfile = "$shscripts/$version[$v]/m8_fold_boostrap_mea_gamma1_$version[$v].sh";
	print FILE "sh $shfile\n";
    }
    print FILE "\n";
     ...
     #mea_auc boostrap
    for (my $v = 0; $v < $NV; $v ++) { 
	$shfile = "$shscripts/$version[$v]/m8_fold_boostrap_mea_auc_$version[$v].sh";
	print FILE "sh $shfile\n";
    }
    print FILE "\n";
    ...
    #cyk Rfam3D boostrap
    for (my $v = 0; $v < $NV; $v ++) { 
	$shfile = "$shscripts/$version[$v]/m8_fold_Rfam3D_boostrap_cyk_$version[$v].sh";
	print FILE "sh $shfile\n";
    }
    print FILE "\n";

     #mea gamma=1 Rfam3D boostrap
     for (my $v = 0; $v < $NV; $v ++) { 
	$shfile = "$shscripts/$version[$v]/m8_fold_Rfam3D_boostrap_mea_gamma1_$version[$v].sh";
	print FILE "sh $shfile\n";
    }
    print FILE "\n";

     #mea_auc Rfam3D boostrap
    for (my $v = 0; $v < $NV; $v ++) { 
	$shfile = "$shscripts/$version[$v]/m8_fold_Rfam3D_boostrap_mea_auc_$version[$v].sh";
	print FILE "sh $shfile\n";
    }
    print FILE "\n";
	...
	#mea gamma=1 jacknife
	for (my $v = 0; $v < $NV; $v ++) { 
	    $shfile = "$shscripts/$version[$v]/m8_fold_jacknife$j\_mea_gamma1_$version[$v].sh";
	    print FILE "sh $shfile\n";
	}
	print FILE "\n";
	...
	#mea_auc jacknife
	for (my $v = 0; $v < $NV; $v ++) { 
	    $shfile = "$shscripts/$version[$v]/m8_fold_jacknife$j\_mea_auc_$version[$v].sh";
	    print FILE "sh $shfile\n";
	}
	print FILE "\n";
    }
...
sub create_sh_file {
	...
	#command line
	my $cmd = "$rnastructure_script ";
	#option (the parameter set used)
	if ($foldtype =~ /cyk/)               { $cmd .= "-s 1 -V "; }
	if ($foldtype =~ /mea_gamma1/)        { $cmd .= "-s 1 -M 1 "; }
	if ($foldtype =~ /mea_auc/)           { $cmd .= "-s 1 -U -t $tstofile "; }
