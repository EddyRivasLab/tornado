#!/usr/bin/perl -w
#stombaugh_nar2009_to_stofiles.pl
...
if (@ARGV) {
        print "usage:  stombaugh_nar2009_to_stofiles.pl [options] \n\n";
        print "options:\n";
	print "-v :  be verbose\n";
	exit;
}
...
my $stombaughdir = "$outdir/Stombaugh_NAR_2009_alignments_and_annotations";
...
my $outfile;
my $outfilesingle;
my $outgrmfile12 = "$stombaughdir/grm/stombaugh_NAR2009_5S_16S_23S_bacteria_12bps.grm";
my $outgrmfile18 = "$stombaughdir/grm/stombaugh_NAR2009_5S_16S_23S_bacteria_18bps.grm";
...
$outfile       = "$stombaughdir/sto/Stombaugh_et_al_Sup_Mat_S1_5S_ecoli.sto";
$outfilesingle = "$stombaughdir/sto/Stombaugh_et_al_Sup_Mat_S1_5S_ecoli_single.sto";
system("rm $outfile\n");
my $num = 1;
$nf ++;
$RNAali[$nf]       = $outfile;
...
$outfile       = "$stombaughdir/sto/Stombaugh_et_al_Sup_Mat_S2_16S_ecoli.sto";
$outfilesingle = "$stombaughdir/sto/Stombaugh_et_al_Sup_Mat_S2_16S_ecoli_single.sto";
system("rm $outfile\n");
$nf ++;
$RNAali[$nf]       = $outfile;
$RNAalisingle[$nf] = $outfilesingle;
...
# 23S bacterial - Ecoli as reference
    ...
    $outfile       = "$stombaughdir/sto/Stombaugh_et_al_Sup_Mat_S3_23S_ecoli.sto";
    $outfilesingle = "$stombaughdir/sto/Stombaugh_et_al_Sup_Mat_S3_23S_ecoli_single.sto";
    system("rm $outfile\n");
    $nf ++;
    $RNAali[$nf]       = $outfile;
    $RNAalisingle[$nf] = $outfilesingle;
...
my @RNAaliall;
my @RNAaliallsingle;
$RNAaliall[0]       = ($add_23S)? "$outdir/Stombaugh_NAR2009.sto"        : "$outdir/Stombaugh_NAR2009_5S_16S.sto";
$RNAaliallsingle[0] = ($add_23S)? "$outdir/Stombaugh_NAR2009_single.sto" : "$outdir/Stombaugh_NAR2009_5S_16S_single.sto";
...
######################################################
my $stats_out = ($add_23S)? "$outdir/Stombaugh_NAR2009.stats" : "$outdir/Stombaugh_NAR2009_5S_16S.stats" ;
system("rm $stats_out\n");
...
my $twelve  = 0;
my $tornado = 0;
FUNCS::print_bps("stdout", "ALL REFSEQS-18", $twelve, $tornado,
		 $ref_nbp_cWW, $ref_nbp_tWW, $ref_nbp_cWH, $ref_nbp_tWH, $ref_nbp_cWS, $ref_nbp_tWS,
		 $ref_nbp_cHW, $ref_nbp_tHW, $ref_nbp_cHH, $ref_nbp_tHH, $ref_nbp_cHS, $ref_nbp_tHS,
		 $ref_nbp_cSW, $ref_nbp_tSW, $ref_nbp_cSH, $ref_nbp_tSH, $ref_nbp_cSS, $ref_nbp_tSS,
		 \@ref_cWW, \@ref_tWW, \@ref_cWH, \@ref_tWH, \@ref_cWS, \@ref_tWS,
