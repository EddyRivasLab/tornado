...
Mpp  : "." Mpp  | M1mm Mmp | Rmp 
Mmp  :            M1mm Mmp | Rmp 

Mpm  : "." Mpm  | M1mm Mmm | M1mm 
Mmm  :            M1mm Mmm | M1mm
...
/*
The original Tornado grammar basic_grammar_dangle.grm
...
M^{pp}  --> a M^{pp} e1 | M1^{mm} M^{mp} | R^{mp} 
M^{mp}  -->               M1^{mm} M^{mp} | R^{mp} 

M^{pm}  --> a M^{pm} e1 | M1^{mm} M^{mm} | M1^{mm} 
